			...
			<div class="food-menu-content">
				...
				<ul class="food-menu-list">
						...
						<div class="food-menu-item-header clear">
							<h3 class="food-menu-heading">Marineret sild med Karrysalat</h3>
							<span class="food-menu-price">kr. 55,-</span> </div>
					...
					<li class="food-menu-item">
						<div class="food-menu-item-header clear">
							<h3 class="food-menu-heading">Kryddersild med løg og kapers</h3>
							<span class="food-menu-price">kr. 55,-</span> </div>
						<div class="food-menu-summary">
							<p> 
								<!--BESKRIVENDE TEKST HER--> 
					...
					<li class="food-menu-item">
						<div class="food-menu-item-header clear">
							<h3 class="food-menu-heading">Lun fiskefilet med remoulade</h3>
							<span class="food-menu-price">kr. 70,-</span> </div>
						<div class="food-menu-summary">
							<p> 
								<!--BESKRIVENDE TEKST HER--> 
							</p>
					...
					<li class="food-menu-item">
						<div class="food-menu-item-header clear">
							<h3 class="food-menu-heading">Røget ål</h3>
							<span class="food-menu-price">kr. 95,-</span> </div>
						<div class="food-menu-summary">
					...
					<li class="food-menu-item">
						<div class="food-menu-item-header clear">
							<h3 class="food-menu-heading">Stjerneskud</h3>
							<span class="food-menu-price">kr. 118,-</span> </div>
						<div class="food-menu-summary">
							<p> 
					...
					<li class="food-menu-item">
						<div class="food-menu-item-header clear">
							<h3 class="food-menu-heading">3 hjemmelavede frikadeller</h3>
							<span class="food-menu-price">kr. 75,-</span> </div>
						<div class="food-menu-summary">
							<p> 
					...
					<li class="food-menu-item">
						<div class="food-menu-item-header clear">
							<h3 class="food-menu-heading">Bøf med bløde løg og spejlæg</h3>
							<span class="food-menu-price">kr. 118,-</span> </div>
						<div class="food-menu-summary">
							<p> 
								<!--BESKRIVENDE TEKST HER--> 
					...
					<li class="food-menu-item">
						<div class="food-menu-item-header clear">
							<h3 class="food-menu-heading">Pariserbøf</h3>
							<span class="food-menu-price">kr. 118,-</span> </div>
						<div class="food-menu-summary">
							<p> 
					...
					<li class="food-menu-item">
						<div class="food-menu-item-header clear">
							<h3 class="food-menu-heading">Mørbradbøf med champignon a la créme</h3>
							<span class="food-menu-price">kr. 118,-</span> </div>
						<div class="food-menu-summary">
							<p> 
								<!--BESKRIVENDE TEKST HER--> 
					...
					<li class="food-menu-item">
						<div class="food-menu-item-header clear">
							<h3 class="food-menu-heading">Mørbradbøf med løg og champignon</h3>
							<span class="food-menu-price">kr. 118,-</span> </div>
						<div class="food-menu-summary">
							<p> 
								<!--BESKRIVENDE TEKST HER--> 
					...
					<li class="food-menu-item">
						<div class="food-menu-item-header clear">
							<h3 class="food-menu-heading">Gorgonzola med æggeblomme og rå løg</h3>
							<span class="food-menu-price">kr. 75,-</span> </div>
						<div class="food-menu-summary">
					...
					<li class="food-menu-item">
						<div class="food-menu-item-header clear">
							<h3 class="food-menu-heading">2 tarteletter med hjemmelavet høns i asparges</h3>
							<span class="food-menu-price">kr. 70,-</span> </div>
						<div class="food-menu-summary">
							<p> 
								<!--BESKRIVENDE TEKST HER--> 
					...
					<li class="food-menu-item">
						<div class="food-menu-item-header clear">
							<h3 class="food-menu-heading">Æggekage med purløg og bacon</h3>
							<span class="food-menu-price">kr. 118,-</span> </div>
						<div class="food-menu-summary">
							<p> 
								<!--BESKRIVENDE TEKST HER--> 
					...
					<li class="food-menu-item">
						<div class="food-menu-item-header clear">
							<h3 class="food-menu-heading">Franskbrød med rejer</h3>
							<span class="food-menu-price">kr. 105,-</span> </div>
						<div class="food-menu-summary">
							<p> 
								<!--BESKRIVENDE TEKST HER--> 
							</p>
					...
					<li class="food-menu-item">
						<div class="food-menu-item-header clear">
							<h3 class="food-menu-heading">Gl. Ole med rå løg, sky og rom</h3>
							<span class="food-menu-price">kr. 85,-</span> </div>
						<div class="food-menu-summary">
							<p> 
								<!--BESKRIVENDE TEKST HER--> 
							</p>
					...
					<li class="food-menu-item">
						<div class="food-menu-item-header clear">
							<h3 class="food-menu-heading">Franskbrød med ost</h3>
							<span class="food-menu-price">kr. 55,-</span> </div>
						<div class="food-menu-summary">
							<p> 
								<!--BESKRIVENDE TEKST HER--> 
